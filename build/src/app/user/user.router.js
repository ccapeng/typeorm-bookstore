...
let UserPermissionController = class UserPermissionController extends tsoa_1.Controller {
    getAllUser() {
        return __awaiter(this, void 0, void 0, function* () {
            return user_service_1.getAllUser();
        });
    }
    createUser(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return user_service_1.createUser({ email: body.email, roles: body.roles });
        });
    }
    updateUser(id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            return user_service_1.updateUser({ id: Number(id), email: body.email, roles: body.roles });
        });
    }
    deleteUser(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return user_service_1.deleteUser({ id: Number(id) });
        });
    }
};
__decorate([
...
__decorate([
    tsoa_1.Put('/update/{id}/'),
    __param(0, tsoa_1.Query('id')), __param(1, tsoa_1.Body()),
    __metadata("design:type", Function),
